...
# read in data
countdata = read.csv("~/MSBAsummer20/STA380-master/data/congress109.csv", header=TRUE, row.names=1)
memberdata = read.csv("~/MSBAsummer20/STA380-master/data/congress109members.csv", header=TRUE, row.names=1)
